Pod::Spec.new do |s|
   ...
   s.dependency 'AWSAuthCore', '2.33.22'
   s.dependency 'AWSCognitoIdentityProvider', '2.33.22'
   ...
   s.dependency 'AWSCore', '2.33.22'
   s.dependency 'AWSCognitoIdentityProviderASF', '2.33.22'
