Pod::Spec.new do |s|
   ...
   s.dependency 'AWSAuthCore', '2.33.17'
   s.dependency 'AWSCognitoIdentityProvider', '2.33.17'
   ...
   s.dependency 'AWSCore', '2.33.17'
   s.dependency 'AWSCognitoIdentityProviderASF', '2.33.17'
